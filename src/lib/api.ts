...
export interface BroadcastOrderBody { symbol: string; side: 'buy'|'sell'; usdt_amount?: number; balance_pct?: number; leverage?: number; order_type?: 'market'|'limit'; limit_price?: number; sl?: number; tp?: number; }
